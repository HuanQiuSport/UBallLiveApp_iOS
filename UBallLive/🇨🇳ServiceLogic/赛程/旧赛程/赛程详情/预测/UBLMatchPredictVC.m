...
#import "UBLMatchPredictVC.h"
#import "UBLMatchPredictHostTeamVC.h"//主队
#import "UBLMatchPredictGuestTeamVC.h"//客队

@interface UBLMatchPredictVC ()
<
...
@implementation UBLMatchPredictVC
...
-(NSMutableArray *)childVCMutArr{
    if (!_childVCMutArr) {
        ...
        [_childVCMutArr addObject:UBLMatchPredictHostTeamVC.new];
        [_childVCMutArr addObject:UBLMatchPredictGuestTeamVC.new];
