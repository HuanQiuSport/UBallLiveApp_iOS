...
#import "UBLEuropeanOddsVC.h"

@interface UBLEuropeanOddsVC ()
<
...
@implementation UBLEuropeanOddsVC
...
- (nonnull __kindof UICollectionViewCell *)collectionView:(nonnull UICollectionView *)collectionView
    ...
    UBLVideoCollectionViewCell_Style16 *cell = (UBLVideoCollectionViewCell_Style16 *)[collectionView dequeueReusableCellWithReuseIdentifier:@"UBLVideoCollectionViewCell_Style16" forIndexPath:indexPath];
...
- (UICollectionReusableView *)collectionView:(UICollectionView *)collectionView
    ...
    if (kind == UICollectionElementKindSectionHeader) {
        ...
        headerView.indexType = MatchIndexType_EuropeanOdds;
        return headerView;
    }else{
        return nil;
    }
...
- (CGSize)collectionView:(UICollectionView *)collectionView
  ...
  sizeForItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    return [UBLVideoCollectionViewCell_Style16 cellSizeWithModel:nil];
}
///每个item之间的间距 横（行）间距
