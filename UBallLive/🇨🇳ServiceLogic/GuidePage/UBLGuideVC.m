...
@interface UBLGuideVC ()<KSGuideDelegate>
@end
@implementation UBLGuideVC
- (void)viewDidLoad{
    [super viewDidLoad];
...
//
    [paths addObject:[UIImage imageNamed:@"1"]];
    [paths addObject:[UIImage imageNamed:@"2"]];
    [paths addObject:[UIImage imageNamed:@"3"]];
    [paths addObject:[UIImage imageNamed:@"4"]];
    //设置委托
...
- (void)touchesBegan:(NSSet<UITouch *> *)touches withEvent:(UIEvent *)event{
    if (self.mkDelegate && [self.mkDelegate respondsToSelector:@selector(didClickCancel)]) {
