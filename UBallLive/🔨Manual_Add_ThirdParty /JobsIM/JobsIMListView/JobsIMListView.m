...
@property(nonatomic,copy)MKDataBlock jobsIMListViewBlock;
...
didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    if (self.jobsIMListViewBlock) {
        self.jobsIMListViewBlock(self.jobsIMListMutArr[indexPath.row]);
    }
}
...
-(UITableViewCell *)tableView:(UITableView *)tableView
    ...
    JobsIMListTBVCell *cell = [JobsIMListTBVCell cellWithTableView:tableView];
...
-(void)actionBlockJobsIMListView:(MKDataBlock)jobsIMListViewBlock{
    self.jobsIMListViewBlock = jobsIMListViewBlock;
}
