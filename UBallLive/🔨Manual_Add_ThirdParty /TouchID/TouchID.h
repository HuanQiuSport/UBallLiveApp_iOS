...
@property(nonatomic,strong)void(^MyBlock_TouchID_Style_Details)(TouchID_Style_Details);

@property(nonatomic,strong)void(^MyBlock_TouchID_Success_Or_Error)(TouchID_Success_Or_Error);
